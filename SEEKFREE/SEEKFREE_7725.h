...
extern u8 image_bin[OV7725_SIZE];

//函数声明
extern  u8      ov7725_init(void);
extern  void    Image_Decompression(u8 *data1,u8 *data2);
extern  void    seekfree_sendimg_7725(void *imgaddr, u32 imgsize);
